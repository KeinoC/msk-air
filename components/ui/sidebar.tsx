			...
			>
				...
				<div
					className={cn(
						...
						variant === "inset" ? "w-68" : "w-[--sidebar-width]",
						// Collapsed width for icon collapsible
						variant === "floating" || variant === "inset"
							? "group-data-[collapsible=icon]:group-data-[state=collapsed]:w-20"
				...
				<div
					className={cn(
						...
						variant === "floating" || variant === "inset"
							? "w-[calc(var(--sidebar-width)_+_theme(spacing.4)_+2px)] p-2 group-data-[collapsible=icon]:group-data-[state=collapsed]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
	...
	return (
		<main
			...
			className={cn(
				...
				"md:ml-[16rem] peer-data-[collapsible=offcanvas]:peer-data-[state=collapsed]:md:ml-0",
				className,
			)}
			{...props}
		/>
